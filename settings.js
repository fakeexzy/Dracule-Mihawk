/**
   * Made By Fandyyy 🕴️
   * GATAU NIH IKUTIN AE
   * Follow https://instagram.com/fakeexzy
   * Follow https://github.com/fakeexzy
*/
...
global.author = 'By EXZY HARD LEVEL' //Ganti Jadi Namamu
global.prefa = ['','.','#','!'] //Ilangin Prefix Yang '' Kalau Gamau No Prefix
global.sessionName = 'session' //Saran Gausah Diganti Lagi
global.webme = 'https://github.com/fakeexzy' //Ganti Jadi Bebas Web Sosmed Mu
...
global.quotes = {
welcome: 'Semoga Kamu Betah Berada Disini Dan Jangan Lupa Untuk Selalu Mengikuti Rules Yang Ada Dan Jangan lupa Support OwnerBot',
